...
(async () => {
  ...
  // 1. Replace any detected language code with target language using single unified pattern
  const candidate = url.replace(new RegExp(`\\b${langPattern}\\b`, 'gi'), targetLangConfig.code)
